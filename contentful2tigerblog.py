...
def run(content_path):
    ...
    for item in items:
        ...
        post_path = f"{content_path}/{lang}/posts/{slug}"
        img_filename = media_data.get("fileName", "")
...
Usage:
  contentful2tigerblog.py [<content_path>]
...
if __name__ == '__main__':
    ...
    content_path = arguments['<content_path>'] if arguments['<content_path>'] else "content"
    run(content_path)
